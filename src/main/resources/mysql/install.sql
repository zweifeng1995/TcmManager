...
(
    ...
    nature_and_flavor    VARCHAR(2048),                                       -- 性味
    channel_tropism      VARCHAR(2048),                                       -- 归经
    efficacy             VARCHAR(2048),                                       -- 功效
    clinical_application VARCHAR(2048),                                       -- 临床应用
    created_time         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,        -- 创建时间
    updated_time         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,        -- 更新时间
    PRIMARY KEY (id),
